...
>
    {#if show_code}
        <div
            id="first"
            class={`my-auto w-[400px] h-[400px]  ${$padding} ${bg_color}  ${$border_width} ${border_color} ${$border_radius} ${$ring_width} ${ring_color}  ${outline_property_array} ${outline_color}`}
        />
    {:else}
      ...
      {`my-auto w-[400px] h-[400px]  ${$padding} ${bg_color}  ${$border_width} ${border_color} ${$border_radius} ${$ring_width} ${ring_color}  ${outline_property_array} ${outline_color}`}
        </code>
      </pre>
        </div>
    {/if}
